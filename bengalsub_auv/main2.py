...
# from auv.vision.camera_recorder import CameraRecorder  # Disabled for now
...
class AUVMissionController:
    def __init__(self, config_path="config/main_config.yaml"):
        ...
        # self.camera_recorder = CameraRecorder()  # Disabled for now
        self.camera_recorder = None  # No cameras for now
    ...
    def manual_arm(self):
        ...
        try:
            ...
            # Start camera recording (disabled for now)
            # self.camera_recorder.start_recording()
            print("📷 Camera recording disabled")
            
            self.is_armed = True
            self.logger.info("✅ AUV armed successfully (no cameras)")
            return True
    ...
    def manual_disarm(self):
        ...
        try:
            ...
            # Stop camera recording (disabled for now)
            # self.camera_recorder.stop_recording()
            print("📷 Camera recording was disabled")
            ...
            self.is_armed = False
            self.logger.info("✅ AUV disarmed successfully (no cameras)")
            return True
